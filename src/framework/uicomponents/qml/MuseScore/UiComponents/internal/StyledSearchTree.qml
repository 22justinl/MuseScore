...
property int preferredAlign: Qt.AlignRight // Left, HCenter, Right
    ...
    function calculateSize() {
        ...
        root.contentHeight = Math.min(itemHeight * itemsCount + sepCount * prv.separatorHeight +
                                      prv.viewVerticalMargin, anchorItemHeight - padding * 2)
    ...
    contentItem: PopupContent {
        ...
        contentHeight: root.contentHeight + searchField.height + prv.viewVerticalMargin * 2 + prv.separatorHeight
        ...
        ColumnLayout {
            ...
            SearchField {
                ...
                Layout.margins: prv.viewVerticalMargin
            ...
            StyledListView {
                ...
                Layout.bottomMargin: prv.viewVerticalMargin
